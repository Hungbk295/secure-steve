...
interface BlacklistFilterBarProps {
  loading?: boolean;
  className?: string;
}
...
function BlacklistFilterBar({
  loading = false,
  className,
}: BlacklistFilterBarProps) {
  ...
  function onFinish(values: DynamicKeyObject) {
    ...
    dispatch(actionGetFilePolicies({ type: activeTab, filters: payload }));
  }
...
export default BlacklistFilterBar;
